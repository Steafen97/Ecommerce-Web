        ...
        <div class="container mx-auto">
            <div class="max-w-md mx-auto my-10 bg-white border-2 p-5 rounded-md shadow-sm">
                <div class="text-center">
                    <h1 class="my-3 text-3xl font-semibold text-gray-700 ">Tambah Produk</h1>
                ...
                <div class="m-7">
                    <form action="/product" method="POST" id="form">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="price" value="{{ old('price', '') }}" name="price" id="price"
                                class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300" />
                        </div>
                        <div class="mb-6">
                            @error('weight')
                            ...
                            <input type="weight" value="{{ old('weight', '') }}" name="weight" id="weight"
                                class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300" />
                        </div>
                        <div class="mb-6">
                            @error('descriptions')
                            ...
                            <input rows="5" name="descriptions" id="descriptions" value="{{ old('descriptions', '') }}"
                                class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 "></input>
                        </div>
                        <div class="mb-6">
                            @error('image')
                                <div class="text-red-300 font-bold">{{ $message }}</div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="stock" value="{{ old('stock', '') }}" name="stock" id="stock"
                                class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300" />
                        </div>
                        <div class="mb-6">
                            @error('categories_id')
                            ...
                            <input type="categories_id" value="{{ old('categories_id', '') }}" name="categories_id"
                                id="categories_id"
                                class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300" />
                        </div>
                        <div class="mb-6">
